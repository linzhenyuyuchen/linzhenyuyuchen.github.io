...
![](/img/Screen-Shot-2017-08-06-at-2.28.19-PM.png)
...
def update_parameters_with_gd(parameters, grads, learning_rate):
    ...
    for l in range(L):
        ...
        parameters["b" + str(l+1)] = parameters["b" + str(l+1)] - grads['db' + str(1+l)] * learning_rate
        ### END CODE HERE ###
...
**Exercise**: Now, implement the parameters update with momentum where L is the number of layers,  β is the momentum and  α is the learning rate.
...
## Try Mini-batch with each of the 3 optimization methods
